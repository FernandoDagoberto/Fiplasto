...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMPilaBIO))
        ...
        Me.btncancel.Location = New System.Drawing.Point(146, 337)
        ...
        Me.txtcod.Location = New System.Drawing.Point(20, 127)
        ...
        Me.txtcod.Style = MetroFramework.MetroColorStyle.Red
        ...
        Me.Label1.Location = New System.Drawing.Point(20, 157)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(112, 20)
        Me.Label1.Style = MetroFramework.MetroColorStyle.Red
        ...
        Me.CBtipo.FontSize = MetroFramework.MetroComboBoxSize.Small
        Me.CBtipo.FormattingEnabled = True
        Me.CBtipo.ItemHeight = 19
        Me.CBtipo.Location = New System.Drawing.Point(20, 180)
        Me.CBtipo.Name = "CBtipo"
        Me.CBtipo.Size = New System.Drawing.Size(220, 25)
        Me.CBtipo.Style = MetroFramework.MetroColorStyle.Red
        ...
        Me.Label4.Style = MetroFramework.MetroColorStyle.Red
        ...
        Me.TXTtn.Location = New System.Drawing.Point(20, 236)
        ...
        Me.TXTtn.Style = MetroFramework.MetroColorStyle.Red
        Me.TXTtn.TabIndex = 2
        ...
        Me.Label3.Style = MetroFramework.MetroColorStyle.Red
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(511, 41)
        ...
        Me.MetroTile1.Size = New System.Drawing.Size(66, 41)
        ...
        DataGridViewCellStyle2.BackColor = System.Drawing.Color.FromArgb(CType(CType(209, Byte), Integer), CType(CType(17, Byte), Integer), CType(CType(65, Byte), Integer))
        ...
        Me.dg.Location = New System.Drawing.Point(246, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(285, 263)
        Me.dg.Style = MetroFramework.MetroColorStyle.Red
        Me.dg.TabIndex = 29
...
#End Region
    ...
    Private Sub ABMPilaBIO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Opcion(sender As Object, e As EventArgs) Handles BtnNuevo.Click, btnSalir.Click, btnGuardar.Click, btnEditar.Click, btnBorrar.Click
        ...
        Select Case sender.Name
            ...
            Case btnBorrar.Name ' boton borrar
                ms = MetroMessageBox.Show(Me, "Desea eliminar la pila: " + dg.CurrentRow.Cells("tipo").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub modifica()
        If dg.SelectedRows.Count = 1 Then
            ...
            If IsDBNull(dg.CurrentRow.Cells("fecalta").Value) Then
                txtfecalta.Text = ""
            Else
                txtfecalta.Text = dg.CurrentRow.Cells("fecalta").Value
            End If
            txtcod.Focus()
        End If
    End Sub
    ...
    Private Sub buscasiexiste(ByVal pila As String)
        conex("pila")
        sql1 = "SELECT id From BioPila where id='" + Trim(pila) + "'"
    ...
    Private Sub limpia()
        txtcod.Text = Nothing
        TXTtn.Text = Nothing
        txtfecalta.Text = Nothing
    End Sub
    Private Sub buscadatos()
        conex("BioPila")
        sql = "SELECT * From BioPila"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("chofer")
        sql5 = "SELECT * From Biopila where id='" + Trim(txtcod.Text) + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                ...
                If dt1.Rows.Count <> 0 Then
                    MetroMessageBox.Show(Me, "La Pila ya existe ", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If


                campos = "id,tipo, tn,codMad"
                variables = "" + (txtcod.Text) + ",'" + Trim(CBtipo.Text) + "'," + TXTtn.Text + "," + Str(CBtipo.SelectedValue) + ""
                sql3 = "INSERT INTO Biopila (" + campos + ") VALUES (" + variables + ")"
                ...
                Call llenastpila()
            Else
                sql2 = "update Biopila set tipo='" + Trim(CBtipo.Text) + "', tn='" + TXTtn.Text + "',codMad='" + str(CBtipo.SelectedValue) + "' where id='" + Str(Trim(line)) + "' "
        ...
        Else
            MetroMessageBox.Show(Me, "Ese código ya existe", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtcod.Focus()
        End If
    End Sub
    Private Sub dg_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dg.KeyUp
        If e.KeyCode = Keys.Delete Then
            ms = MetroMessageBox.Show(Me, "¿Desea eliminar " + dg.CurrentRow.Cells("tipo").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
            If ms = 1 Then
                Call eliminalinea()
            End If
        End If
    ...
    Private Sub eliminalinea()
        ...
        idl = dg.CurrentRow.Cells(0).Value
        If idl <> "" Then
            sql4 = "delete from Biopila where id='" + idl + "' "
    ...
    Private Sub llenacombo()
        Try
            Call conexA("tipmadera")
            sql1 = "select * from productos where info like '%bio%'"
    ...
    Sub llenastpila()
        campos = "pila,stock"
        variables = "'" + Trim(txtcod.Text) + "','0'"
        sql3 = "INSERT INTO BIOSTOCK (" + campos + ") VALUES (" + variables + ")"
        cmd3 = New SqlCommand(sql3, cnn)
        cmd3.Connection.Open()
        cmd3.ExecuteNonQuery()
        cmd3.Connection.Close()
