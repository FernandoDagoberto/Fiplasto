...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btncancel.Location = New System.Drawing.Point(81, 265)
        ...
        Me.txtcod.Location = New System.Drawing.Point(8, 126)
        ...
        Me.txtdesc.CustomButton.Location = New System.Drawing.Point(215, 2)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(8, 171)
        ...
        Me.cbarea.Location = New System.Drawing.Point(8, 216)
        Me.cbarea.Name = "cbarea"
        Me.cbarea.Size = New System.Drawing.Size(153, 25)
        Me.cbarea.TabIndex = 23
        ...
        Me.dg.Location = New System.Drawing.Point(247, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(339, 216)
        Me.dg.TabIndex = 81
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(581, 41)
        ...
        Me.MetroTile1.Size = New System.Drawing.Size(136, 41)
...
#End Region
    ...
    Private Sub Opcion(sender As Object, e As EventArgs) Handles BtnNuevo.Click, btnSalir.Click, btnGuardar.Click, btnEditar.Click, btnBorrar.Click
        ...
        Select Case sender.Name
            ...
            Case btnBorrar.Name ' boton borrar
                ...
                ms = MetroMessageBox.Show(Me, "Desea eliminar el sector: " + dg.CurrentRow.Cells("Descripcion").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub buscamax()
        conex("sector")
        sql1 = "SELECT max(sector_id)as ult From sector"
    ...
    Private Sub buscadatos()
        conex("sector")
        sql = "SELECT SECTOR.SECTOR_ID as ID, SECTOR.SECTOR_DESC as Descripcion, AREA.AREA_DESC as Area FROM SECTOR LEFT OUTER JOIN " &
              "AREA ON SECTOR.AREA_ID = AREA.AREA_ID order by sector_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("sector")
        sql5 = "SELECT * From sector where sector_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "sector_id,sector_desc,area_id"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "','" + cbarea.SelectedValue + "'"
                sql3 = "INSERT INTO sector (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update sector set sector_desc='" + txtdesc.Text + "' where sector_id='" + txtcod.Text + "' "
