...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMCausa))
        ...
        Me.btncancel.Location = New System.Drawing.Point(140, 215)
        ...
        Me.txtcod.Location = New System.Drawing.Point(17, 134)
        ...
        Me.txtdesc.CustomButton.Location = New System.Drawing.Point(183, 2)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(17, 179)
        ...
        Me.txtdesc.Size = New System.Drawing.Size(201, 20)
        ...
        Me.dg.Location = New System.Drawing.Point(233, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(210, 216)
        Me.dg.TabIndex = 75
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(438, 41)
        Me.MetroPanel1.Style = MetroFramework.MetroColorStyle.Blue
        Me.MetroPanel1.TabIndex = 74
...
#End Region
    ...
    Private Sub ABMCausa_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call buscadatos()
    ...
    Private Sub buscadatos()
        conex("causa")
        sql = "SELECT Causa_id as ID, causa_desc as Descripcion From causa order by causa_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("causa")
        sql5 = "SELECT * From causa where causa_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "causa_id,causa_desc"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "'"
                sql3 = "INSERT INTO causa (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update causa set causa_desc='" + txtdesc.Text + "' where causa_id='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        sql4 = "delete from causa where causa_id='" + Trim(linea) + "' "
