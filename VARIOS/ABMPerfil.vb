...
Public Class ABMPerfil
    ...
    Friend WithEvents cbcargo As MetroComboBox
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMPerfil))
        ...
        Me.btncancel.Location = New System.Drawing.Point(160, 316)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(22, 181)
        ...
        Me.cbarea.Location = New System.Drawing.Point(22, 226)
        Me.cbarea.Name = "cbarea"
        Me.cbarea.Size = New System.Drawing.Size(88, 25)
        Me.cbarea.TabIndex = 22
        ...
        'cbcargo
        '
        Me.cbcargo.FontSize = MetroFramework.MetroComboBoxSize.Small
        Me.cbcargo.FormattingEnabled = True
        Me.cbcargo.ItemHeight = 19
        Me.cbcargo.Location = New System.Drawing.Point(22, 276)
        Me.cbcargo.Name = "cbcargo"
        Me.cbcargo.Size = New System.Drawing.Size(88, 25)
        Me.cbcargo.TabIndex = 24
        ...
        Me.dg.Location = New System.Drawing.Point(253, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(366, 279)
        Me.dg.TabIndex = 81
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(614, 41)
        ...
        Me.MetroTile1.Size = New System.Drawing.Size(169, 41)
...
#End Region
    ...
    Private Sub ABMPerfil_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call llenacombo()
        Call llenacargo()
        Call buscadatos()
    ...
    Private Sub Opcion(sender As Object, e As EventArgs) Handles BtnNuevo.Click, btnSalir.Click, btnGuardar.Click, btnEditar.Click, btnBorrar.Click
        ...
        Select Case sender.Name
            ...
            Case btnBorrar.Name ' boton borrar
                ...
                ms = MetroMessageBox.Show(Me, "Desea eliminar el perfil: " + dg.CurrentRow.Cells("Descripcion").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub modifica()
        If dg.SelectedRows.Count = 1 Then
            ...
            cbcargo.Text = dg.CurrentRow.Cells("Cargo").Value
            txtcod.Focus()
        End If
    End Sub
    ...
    Private Sub buscamax()
        conex("perfil")
        sql1 = "SELECT max(perfil_id)as ult From perfil"
    ...
    Private Sub buscadatos()
        conex("perfil")
        sql = "SELECT PERFIL.PERFIL_ID as ID, PERFIL.PERFIL_DESC as Descripcion, AREA.AREA_DESC as Area,CARGO_DESC AS Cargo " &
            "FROM PERFIL INNER JOIN CARGO ON PERFIL.PERFIL_CARGO = CARGO.CARGO_ID INNER JOIN " &
            "AREA ON PERFIL.PERFIL_AREA = AREA.AREA_ID ORDER BY PERFIL.PERFIL_ID"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("perfil")
        sql5 = "SELECT * From perfil where perfil_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "perfil_id,perfil_desc,perfil_area,perfil_cargo"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "','" + cbarea.SelectedValue + "','" + cbcargo.SelectedValue + "'"
                sql3 = "INSERT INTO perfil (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update perfil set perfil_desc='" + txtdesc.Text + "',perfil_area='" + cbarea.SelectedValue + "',perfil_cargo='" + cbcargo.SelectedValue + "' where perfil_id='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        sql4 = "delete from perfil where perfil_id='" + Trim(linea) + "' "
    ...
    Sub llenacombo()
        llenacb("area")
        cbarea.DataSource = dt7
        cbarea.DisplayMember = "area_desc"
        cbarea.ValueMember = "area_id"
    End Sub

    Sub llenacargo()
        sql8 = "SELECT * From cargo order by cargo_desc"
        da8 = New SqlDataAdapter(sql8, cnn)
        dt8 = New DataTable
        da8.Fill(dt8)
        n = dt8.Rows.Count

        cbcargo.DataSource = dt8
        cbcargo.DisplayMember = "cargo_desc"
        cbcargo.ValueMember = "cargo_id"
