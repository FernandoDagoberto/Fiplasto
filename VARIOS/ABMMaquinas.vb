...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMMaquinas))
        ...
        Me.btncancel.Location = New System.Drawing.Point(146, 206)
        ...
        Me.txtcod.Location = New System.Drawing.Point(8, 135)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(8, 180)
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(464, 41)
        Me.MetroPanel1.Style = MetroFramework.MetroColorStyle.Blue
        Me.MetroPanel1.TabIndex = 76
...
#End Region
    ...
    Private Sub ABMMAQUINAS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call buscadatos()
    ...
    Private Sub Opcion(sender As Object, e As EventArgs) Handles BtnNuevo.Click, btnSalir.Click, btnGuardar.Click, btnEditar.Click, btnBorrar.Click
        ...
        Select Case sender.Name
            ...
            Case btnBorrar.Name ' boton borrar
                ms = MetroMessageBox.Show(Me, "Desea eliminar la máquina: " + dg.CurrentRow.Cells("Descripcion").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub buscamax()
        conex("MAQUINAS")
        sql1 = "SELECT max(MAQUINAS_id)as ult From MAQUINAS"
    ...
    Private Sub buscadatos()
        conex("MAQUINAS")
        sql = "SELECT MAQUINAS_id as ID, MAQUINAS_desc as Descripcion From MAQUINAS order by MAQUINAS_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("MAQUINAS")
        sql5 = "SELECT * From MAQUINAS where MAQUINAS_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "MAQUINAS_id,MAQUINAS_desc"
                variables = "'" + RTrim(txtcod.Text) + "','" + txtdesc.Text + "'"
                sql3 = "INSERT INTO MAQUINAS (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update MAQUINAS set MAQUINAS_desc='" + txtdesc.Text + "' where MAQUINAS_id='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        sql4 = "delete from Maquinas where MAQUINAS_id='" + Trim(linea) + "' "
