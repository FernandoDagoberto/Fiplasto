...
Public Class ABMArea
    ...
    Friend WithEvents cbrelacion As MetroComboBox
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMArea))
        ...
        Me.cbrelacion = New MetroFramework.Controls.MetroComboBox()
        ...
        Me.btncancel.Location = New System.Drawing.Point(135, 266)
        ...
        Me.txtcod.Location = New System.Drawing.Point(8, 131)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(8, 176)
        ...
        Me.txtdesc.Style = MetroFramework.MetroColorStyle.Yellow
        ...
        'cbrelacion
        '
        Me.cbrelacion.FlatStyle = System.Windows.Forms.FlatStyle.Flat
        Me.cbrelacion.FontSize = MetroFramework.MetroComboBoxSize.Small
        Me.cbrelacion.FormattingEnabled = True
        Me.cbrelacion.ItemHeight = 19
        Me.cbrelacion.Location = New System.Drawing.Point(8, 221)
        Me.cbrelacion.Name = "cbrelacion"
        Me.cbrelacion.Size = New System.Drawing.Size(108, 25)
        Me.cbrelacion.TabIndex = 22
        Me.cbrelacion.UseSelectable = True
        '
        'Label1
        '
        ...
        Me.Label1.Location = New System.Drawing.Point(8, 199)
        ...
        Me.dg.Location = New System.Drawing.Point(230, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(297, 216)
        Me.dg.TabIndex = 73
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(522, 41)
        Me.MetroPanel1.Style = MetroFramework.MetroColorStyle.Blue
        Me.MetroPanel1.TabIndex = 72
        ...
        Me.ClientSize = New System.Drawing.Size(532, 322)
        Me.ControlBox = False
        Me.Controls.Add(Me.dg)
        Me.Controls.Add(Me.MetroPanel1)
        Me.Controls.Add(Me.Label1)
        Me.Controls.Add(Me.cbrelacion)
...
#End Region
    ...
    Private Sub ABMArea_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call llenacombo()
        Call buscadatos()
        ...
        Select Case sender.Name
            ...
            Case BtnNuevo.Name ' boton nuevo
                ...
                If IsDBNull(dt1.Rows(0).Item("ULT")) Then
                    txtcod.Text = "001"
                Else
                    txtcod.Text = Format(dt1.Rows(0).Item("ULT") + 1, "00#.#")
                    txtcod.Focus()
                End If
            ...
            Case btnBorrar.Name ' boton borrar
                ...
                ms = MetroMessageBox.Show(Me, "Desea eliminar el area: " + dg.CurrentRow.Cells("Descripcion").Value + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub modifica()
        If dg.SelectedRows.Count = 1 Then
            ...
            sql5 = "select area_desc from area where area_id='" + Trim(dg.CurrentRow.Cells("Relacion").Value) + "'"
            ...
            If n = 0 Then
                cbrelacion.Text = ""
            Else
                cbrelacion.Text = dt5.Rows(0).Item("area_desc")
            End If
            txtcod.Focus()
    ...
    Private Sub buscamax()
        conex("area")
        sql1 = "SELECT max(area_id)as ult From area"
    ...
    Private Sub buscadatos()
        conex("area")
        sql = "SELECT AREA_ID as ID,AREA_DESC as Descripcion,AREA_RELACION as Relacion From area order by area_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("area")
        sql5 = "SELECT * From area where area_id='" + txtcod.Text + "';"
        da5 = New SqlDataAdapter(sql5, cnn)
        dt5 = New DataTable
        da5.Fill(dt5)
        n = dt5.Rows.Count
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "area_id,area_desc,area_relacion"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "','" + cbrelacion.SelectedValue + "'"
                sql3 = "INSERT INTO area (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update area set area_desc='" + txtdesc.Text + "',area_relacion='" + cbrelacion.SelectedValue + "' where area_id='" + txtcod.Text + "' "
        ...
        Else
            MetroMessageBox.Show(Me, "Código existente", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtcod.Focus()
        End If
    End Sub
    ...
    Private Sub eliminalinea()
        ...
        sql4 = "delete from area where area_id='" + Trim(linea) + "' "
    ...
    Sub llenacombo()
        llenacb("area")
        cbrelacion.DataSource = dt7
        cbrelacion.DisplayMember = "area_desc"
        cbrelacion.ValueMember = "area_id"
    End Sub
