...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMReparo))
        ...
        Me.btncancel.Location = New System.Drawing.Point(174, 227)
        ...
        Me.txtcod.Location = New System.Drawing.Point(36, 138)
        ...
        Me.txtdesc.Location = New System.Drawing.Point(36, 183)
        ...
        Me.dg.Location = New System.Drawing.Point(271, 101)
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(505, 41)
        ...
        Me.MetroTile1.Size = New System.Drawing.Size(60, 41)
...
#End Region
    ...
    Private Sub ABMReparo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call buscadatos()
    ...
    Private Sub buscadatos()
        conex("reparo")
        sql = "SELECT reparo_id as ID, reparo_desc as Descripcion From reparo order by reparo_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("reparo")
        sql5 = "SELECT * From reparo where reparo_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "reparo_id,reparo_desc"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "'"
                sql3 = "INSERT INTO reparo (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update reparo set reparo_desc='" + txtdesc.Text + "' where reparo_id='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        sql4 = "delete from reparo where reparo_id='" + Trim(linea) + "' "
