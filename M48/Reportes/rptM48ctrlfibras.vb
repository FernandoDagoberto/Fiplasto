...
Public Class rptM48ctrlfibras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPIF.rptM48ctrlfibras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptM48ctrlfibras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptM48ctrlfibras = New rptM48ctrlfibras
        rpt.Site = Me.Site
        Return rpt
    End Function
