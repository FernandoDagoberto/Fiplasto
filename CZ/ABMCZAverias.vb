...
Public Class ABMCZAverias
    ...
    Dim sen, campos, variables, idl, dias, line1 As String
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMCZAverias))
        ...
        Me.btncancel.Location = New System.Drawing.Point(154, 234)
        ...
        Me.TXTDESC.CustomButton.Location = New System.Drawing.Point(175, 2)
        Me.TXTDESC.CustomButton.Name = ""
        Me.TXTDESC.CustomButton.Size = New System.Drawing.Size(17, 17)
        ...
        Me.TXTDESC.Location = New System.Drawing.Point(22, 172)
        ...
        Me.TXTDESC.Size = New System.Drawing.Size(195, 22)
        ...
        Me.dg.Location = New System.Drawing.Point(238, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(297, 315)
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(530, 41)
        Me.MetroPanel1.Style = MetroFramework.MetroColorStyle.Blue
        Me.MetroPanel1.TabIndex = 25
...
#End Region
    ...
    Private Sub ABMCZAverias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call bloquea()
        Call buscadatos()
    ...
    Private Sub Opcion(sender As Object, e As EventArgs) Handles BtnNuevo.Click, btnSalir.Click, btnGuardar.Click, btnEditar.Click, btnBorrar.Click
        ...
        Select Case sender.Name
            ...
            Case btnBorrar.Name ' boton borrar
                ...
                ms = MetroMessageBox.Show(Me, "Desea eliminar el defecto: " + dt.Rows(line).Item("czaverias_desc") + " ?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                If ms = 1 Then
                    Call eliminalinea()
    ...
    Private Sub buscamax()
        conex("sector")
        sql1 = "SELECT max(czaverias_id)as ult From CZaverias"
    ...
    Private Sub buscadatos()
        conex("czaverias")
        sql = "SELECT CZAVERIAS_ID as ID,CZAVERIAS_DESC as Descripcion From CZAVERIAS"
    ...
    Private Sub guardanuevo()
        ...
        If sen = "n" Then
            ...
            campos = "CZaverias_ID,CZaverias_DESC"
            variables = "'" + RTrim(txtcod.Text) + "','" + Trim(TXTDESC.Text) + "'"
            sql3 = "INSERT INTO czaverias (" + campos + ") VALUES (" + variables + ")"
            cmd3 = New SqlCommand(sql3, cnn)
            cmd3.Connection.Open()
            cmd3.ExecuteNonQuery()
            cmd3.Connection.Close()
        Else
            sql2 = "update CZaverias set CZaverias_DESC='" + Trim(TXTDESC.Text) + "' where CZaverias_ID='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        If idl <> "" Then
            sql4 = "delete from CZaverias where CZaverias_ID='" + idl + "' "
