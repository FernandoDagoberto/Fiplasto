...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMMotivosNC))
        ...
        Me.txtdesc.Location = New System.Drawing.Point(20, 192)
        ...
        Me.txtcod.Location = New System.Drawing.Point(20, 144)
        ...
        Me.btncancel.Location = New System.Drawing.Point(105, 262)
        ...
        Me.MetroPanel1.Size = New System.Drawing.Size(447, 41)
        ...
        Me.dg.Location = New System.Drawing.Point(203, 101)
...
#End Region
    ...
    Private Sub buscamax()
        conex("MotivoNC")
        sql1 = "SELECT max(MotivoNC_id)as ult From MotivoNC"
    ...
    Private Sub buscadatos()
        conex("MotivoNC")
        sql = "SELECT MotivoNC_id as ID,MotivoNC_desc as Descripcion From MotivoNC order by MotivoNC_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("MotivoNC")
        sql5 = "SELECT * From MotivoNC where MotivoNC_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "MotivoNC_id,MotivoNC_desc"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "'"
                sql3 = "INSERT INTO MotivoNC (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update MotivoNC set MotivoNC_desc='" + txtdesc.Text + "' where MotivoNC_id='" + txtcod.Text + "' "
            ...
            Call bloquea()
        Else
            MetroMessageBox.Show(Me,"Ese código ya existe", MsgBoxStyle.Critical)
            txtcod.Focus()
        End If
    End Sub
    ...
    Private Sub eliminalinea()
        ...
        If idl <> "" Then
            sql4 = "delete from MotivoNC where MotivoNC_id='" + idl + "' "
