...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ABMMotivosPI))
        ...
        Me.dg.Location = New System.Drawing.Point(202, 101)
        ...
        Me.dg.Size = New System.Drawing.Size(250, 216)
...
#End Region
    ...
    Private Sub buscamax()
        conex("MotivoPI")
        sql1 = "SELECT max(MotivoPI_id)as ult From MotivoPI"
    ...
    Private Sub buscadatos()
        conex("MotivoPI")
        sql = "SELECT MotivoPI_id as ID,MotivoPI_desc as Descripcion From MotivoPI order by MotivoPI_id"
    ...
    Private Sub guardanuevo()
        btncancel.Visible = False
        conex("MotivoPI")
        sql5 = "SELECT * From MotivoPI where MotivoPI_id='" + txtcod.Text + "';"
        ...
        If n = 0 Or sen <> "n" Then
            If sen = "n" Then
                campos = "MotivoPI_id,MotivoPI_desc"
                variables = "'" + txtcod.Text + "','" + txtdesc.Text + "'"
                sql3 = "INSERT INTO MotivoPI (" + campos + ") VALUES (" + variables + ")"
                cmd3 = New SqlCommand(sql3, cnn)
                cmd3.Connection.Open()
                cmd3.ExecuteNonQuery()
                cmd3.Connection.Close()
            Else
                sql2 = "update MotivoPI set MotivoPI_desc='" + txtdesc.Text + "' where MotivoPI_id='" + txtcod.Text + "' "
    ...
    Private Sub eliminalinea()
        ...
        If idl <> "" Then
            sql4 = "delete from MotivoPI where MotivoPI_id='" + idl + "' "
