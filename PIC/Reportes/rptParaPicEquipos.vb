...
Public Class rptParaPicEquipos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPIF.rptParaPicEquipos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_equipo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptParaPicEquipos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptParaPicEquipos = New rptParaPicEquipos
        rpt.Site = Me.Site
        Return rpt
    End Function
