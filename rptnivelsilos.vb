...
Public Class rptnivelsilos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fiplasto.rptnivelsilos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptnivelsilos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptnivelsilos = New rptnivelsilos
        rpt.Site = Me.Site
        Return rpt
    End Function
